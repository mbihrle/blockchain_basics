# -*- coding: utf-8 -*-
"""
Created on Sun Aug  6 15:14:29 2023
...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Alex', amount = 1)
...
def connect_node():
    ...
    response = {'message': 'All nodes are now connected. The OneWorldCoin now contains the following nodes', 'total_nodes': list(blockchain.nodes)}
    return jsonify(response), 201
